      ...
      <div class=" col-lg-9   mb-5 mb-lg-0">
        <article>
          <div class="post-slider mb-4">
            <img src="{{ asset('images/' . $post->image) }}" class="card-img" alt="post-thumb">
          </div>
          ...
          <ul class="card-meta my-3 list-inline">
            ...
            <li class="list-inline-item">
              <i class="ti-eye"></i>{{ $post->view }}
            </li>
            <li class="list-inline-item">
              <ul class="card-meta-tag list-inline">
                <li class="list-inline-item"><a href="{{ route('category', ['id' => $post->id]) }}">{{ $post->category_name }}</a></li>
              </ul>
            </li>
          </ul>
          <div class="content">
